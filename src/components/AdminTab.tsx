  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* LEFT COLUMN: UPLOAD MASTER REFERENCE DATA */}
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-5">
          ...
          >
            <input
              ...
              className="hidden"
            />
            <FileSpreadsheet className={`w-8 h-8 mb-2 ${file ? 'text-emerald-600' : 'text-gray-400'}`} />
            {file ? (
              <div>
                <p className="text-xs font-semibold text-gray-950 truncate max-w-[180px]">{file.name}</p>
        ...
        {/* RIGHT COLUMN: INTERACTIVE SQL CLIENT CONSOLE (2-Cols span) */}
